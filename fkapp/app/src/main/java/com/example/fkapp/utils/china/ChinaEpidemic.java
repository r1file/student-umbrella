package com.example.fkapp.utils.china;
...
public class ChinaEpidemic {
    private final JSONObject netDataJsonObject;
    private final String lastUpdateTime;
    private final JSONObject chinaTotalJsonObject;
    ...
    private final JSONObject chinaAddJsonObject;
    ...
    private final JSONArray allAreasJsonArray;
    private final HashMap<String, JSONObject> provinceTotalMap;


    private HashMap<String, JSONArray> eachCityInProvinceMap;
    private final ArrayList<ProvinceTotalInfo> provinceTotalInfos;


    private final ArrayList<String> provinceNameList;
    ...
    public void setEachCityInProvinceMap(HashMap<String, JSONArray> eachCityInProvinceMap) { this.eachCityInProvinceMap = eachCityInProvinceMap; }
    ...
    public ChinaEpidemic(String netDataString) throws JSONException {
